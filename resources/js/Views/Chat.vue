            ...
            <div class="container">
                ...
                <div class="chat-page">
                    <div class="msg-inbox">
                        <div class="chats" id="chats">
                            <div class="msg-page" id="msg-page">
                                ...
                                <div
                                    class="text-center img-fluid empty-chat"
                                    v-else-if="!groupMessages.length"
                                >
                    ...
                    <div class="msg-bottom">
                        <form
                            class="message-form"
                            v-on:submit.prevent="sendGroupMessage"
                        >
...
export default {
    ...
    mounted() {
        ...
        messagesRequest.fetchPrevious().then(
            ...
            error => {
                console.log(
                    'Message fetching failed with error:',
                    error,
                );
            },
        );
