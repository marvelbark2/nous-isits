            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('plan') }}">
                        <i class="ni ni-calendar-grid-58"></i> {{ __('Plan de semaine - EDT') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('task-index') }}">
                        <i class="ni ni-calendar-grid-58"></i> {{ __('Nos Taches') }}
                    </a>
                </li>
                <li class="nav-item mb-5 bg-danger" style="position: absolute; bottom: 0;">
                    <a class="nav-link text-white" href="/qe">
                        <i class="ni ni-ruler-pencil"></i> {{ __('Qe') }}
                    </a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{route('survey-index')}}">
                        <i class="ni ni-chart-pie-35 text-orange"></i> {{ __('Sondages') }}
                    </a>
                </li>
