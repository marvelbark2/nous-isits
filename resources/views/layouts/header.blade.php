...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('home')}}" style="text-transform: uppercase">INPOS - Younes </a>
                                ...
                                <div class="user-info">
                                    ...
                                    <div class="info-container">
                                        <div class="sub-info-container">
                                            <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">youness</div>
                                            <div class="email">ttt@r.php</div>
                                        </div>
                                    </div>
                                </div>
                            </ul>
