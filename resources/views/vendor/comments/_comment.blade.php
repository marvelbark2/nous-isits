    ...
    <div class="media-body">
        ...
        <div>
            @can('reply-to-comment', $comment)
                <button data-toggle="modal" data-target="#reply-modal-{{ $comment->id }}" class="btn btn-sm btn-link text-uppercase">Repondre</button>
            @endcan
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('comments.reply', $comment->id) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="message">Enter votre message ici:</label>
